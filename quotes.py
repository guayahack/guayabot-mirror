...
def read_yaml_quotes(yaml_file:str):
    """
    ...
    Returns:
        list: A list of lists, where each inner list contains an author's name and their associated quote.
...
def add_quote(quote_list:list, yaml_file:str):
    """
...
def format_quote(quote_list:list):
    """
    ...
    Returns:
        str: A formatted representation of the quote with the author, suitable for display.
